...
export function createServer(options: ServerOptions = {}) {
  ...
  let latestContext: VueGrabContext | null = null;
  let contextHistory: VueGrabContext[] = [];
  ...
  app.post('/context', async (req: Request, res: Response) => {
    try {
      const context = req.body as VueGrabContext;
  ...
  // Clear context
  app.delete('/context', (_req: Request, res: Response) => {
    latestContext = null;
    contextHistory = [];
